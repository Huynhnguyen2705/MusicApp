...
/**
 * Created by Huynh on 12/13/2017.
 */

public class FullScreenActivity extends ActionBarCastActitvity {
            ...
            new MediaBrowserCompat.ConnectionCallback() {
                ...
                public void onConnected() {
                    try {
                        ...
                        Log.e("Connect MediaSession", e + " could not connect media controller");
                    }
                }
            };
                ...
                if (state != null) {
                    ...
                    switch (state.getState()) {
                        ...
                        case PlaybackStateCompat.STATE_STOPPED:
                            ...
                            break;
                        default:
                            Log.d("Pause listener error", "onClick with state " + state.getState());
                    }
                }
            }
        });
...
//            }
    ...
    private void updateMediaDescription(MediaDescriptionCompat description) {
        ...
        Log.d("Upđate Media Description", "updateMediaDescription called ");
    ...
    private void updateDuration(MediaMetadataCompat metadata) {
        ...
        Log.d("Update duration", "updateDuration called ");
